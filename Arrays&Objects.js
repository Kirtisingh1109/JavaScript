...
console.log("Updated array :" , numbers);//output : [1,2,3,4,5] in the above code :

//Creating an object representing a person
let person = {name : "Kirti Singh" , age : 25 , isStudent : false , greet : Function(){
